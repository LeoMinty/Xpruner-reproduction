...
class NaFlexVit(nn.Module):
    ...
    def load_pretrained(self, checkpoint_path: str, prefix: str = '') -> None:
        ...
        from .vision_transformer_modified import _load_weights as _orig_load_weights
...
def get_init_weights_vit(mode: str = 'jax', head_bias: float = 0.0) -> Callable:
    ...
    from .vision_transformer_modified import init_weights_vit_jax, init_weights_vit_moco, init_weights_vit_timm
